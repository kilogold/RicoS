...
import { useCart } from "@/lib/commerce/web-client/cart/cart-context";
import type { CartLine } from "@/lib/commerce/web-client/cart/cart-context";
import { formatUsd, linesWithItems, totalCents } from "@/lib/commerce/web-client/cart/pricing";
...
async function fetchEphemeralReference(params: {
  ...
  const res = await fetch("/api/solana/reference", {
    method: "POST",
    cache: "no-store",
